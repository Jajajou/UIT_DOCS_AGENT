...
from agent.agent1_query_understanding_v3 import (
...
def prepare_input(state: QueryStateV3) -> QueryStateV3:
    """
...
def retrieve_data(state: QueryStateV3) -> QueryStateV3:
    """
    Retrieve data from LightRAG using /query/data endpoint.
    
    This node:
    1. Uses parsed_intention from Agent 1
    2. Uses tuned parameters (mode, top_k) from Agent 1
...
def rerank_data(state: QueryStateV3) -> QueryStateV3:
    """
...
def format_final_answer(state: QueryStateV3) -> QueryStateV3:
    """
...
builder = StateGraph(state_schema=QueryStateV3)

# Add nodes
builder.add_node("prepare_input", prepare_input)
builder.add_node("agent1_understand_query", agent1_understand_query_v3)
builder.add_node("ask_clarification", ask_clarification_v3)
